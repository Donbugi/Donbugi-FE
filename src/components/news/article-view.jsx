...
export function ArticleView({ articleId, onBack, onHashtagClick }) {
  ...
  const handleQuizAnswer = (idx) => {
    ...
    setArtQuizDone({ ...artQuizDone, [articleId]: { answered: true, correct: isCorrect, selected: idx } })
    ...
    <div className="flex flex-col flex-1 min-h-0 overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-5 hide-scrollbar">
        ...
        <div className="flex gap-3 items-center mb-4">
          <span className="text-[13px] font-bold text-[#7C3AED]">{article.src}</span>
        ...
        >
          ...
          <span className="text-[13px] font-bold text-[#7C3AED]">원문 보기 — {article.src}</span>
